...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 17 juin 2022 à 16:57
...
(48, 'figma', 'Figma est un éditeur de graphiques vectoriels et un outil de prototypage. Il est principalement basé sur le web, avec des fonctionnalités hors ligne supplémentaires activées par des applications de bureau pour macOS et Windows.', 'https://www.figma.com/fr/resources/learn-design/', '3-DESIGN', 'figma.png');
...
(3, 'ksjeu', 'ejek', '$2y$10$A718bsnGwWe9OyMawumG2uoVh4O1uvonYErClxwGHYfgxxYIffpL.', 'siied12@gmail.com', 'client'),
(4, 'jdkjsd', 'kzjjrk', '$2y$10$xD0uf3B0Ctb0HuFpfjmsjeLZ0rpUiKdngWK4JdGLXGjBfp237xv52', 'ooeoi12@gmail.com', 'client');
...
--
ALTER TABLE `cart_line`
  MODIFY `idCartLine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
